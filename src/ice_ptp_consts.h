 ...
 * reference. See the struct ice_tspll_info_e82x for information about the
 * meaning of each constant.
 */
const struct ice_tspll_info_e82x e82x_tspll[NUM_ICE_TSPLL_FREQ] = {
...
const struct ice_vernier_info_e82x e82x_vernier[NUM_ICE_PTP_LNK_SPD] = {
	[ICE_PTP_LNK_SPD_1G] = {
		.tx_par_clk = 31250000, /* 31.25 MHz */
		.rx_par_clk = 31250000, /* 31.25 MHz */
		.tx_pcs_clk = 125000000, /* 125 MHz */
		.rx_pcs_clk = 125000000, /* 125 MHz */
		.tx_fixed_delay = 25140,
		.pmd_adj_divisor = 10000000,
		.rx_fixed_delay = 17372,
	},
	[ICE_PTP_LNK_SPD_10G] = {
		.tx_par_clk = 257812500, /* 257.8125 MHz */
		.rx_par_clk = 257812500, /* 257.8125 MHz */
		.tx_pcs_clk = 156250000, /* 156.25 MHz */
		.rx_pcs_clk = 156250000, /* 156.25 MHz */
		.tx_fixed_delay = 6938,
		.pmd_adj_divisor = 82500000,
		.rx_fixed_delay = 6212,
	},
	[ICE_PTP_LNK_SPD_25G] = {
		.tx_par_clk = 644531250, /* 644.53125 MHz */
		.rx_par_clk = 644531250, /* 644.53125 MHz */
		.tx_pcs_clk = 390625000, /* 390.625 MHz */
		.rx_pcs_clk = 390625000, /* 390.625 MHz */
		.tx_fixed_delay = 2778,
		.pmd_adj_divisor = 206250000,
		.rx_fixed_delay = 2491,
	},
	[ICE_PTP_LNK_SPD_25G_RS] = {
		.tx_desk_rsgb_par = 161132812, /* 162.1328125 MHz RS gearbox */
		.rx_desk_rsgb_par = 161132812, /* 162.1328125 MHz RS gearbox */
		.tx_desk_rsgb_pcs = 97656250, /* 97.62625 MHz RS gearbox */
		.rx_desk_rsgb_pcs = 97656250, /* 97.62625 MHz RS gearbox */
		.tx_fixed_delay = 3928,
		.pmd_adj_divisor = 206250000,
		.rx_fixed_delay = 29535,
	},
	[ICE_PTP_LNK_SPD_40G] = {
		.tx_par_clk = 257812500,
		.rx_par_clk = 257812500,
		.tx_pcs_clk = 156250000, /* 156.25 MHz */
		.rx_pcs_clk = 156250000, /* 156.25 MHz */
		.rx_desk_rsgb_par = 156250000, /* 156.25 MHz deskew clock */
		.rx_desk_rsgb_pcs = 156250000, /* 156.25 MHz deskew clock */
		.tx_fixed_delay = 5666,
		.pmd_adj_divisor = 82500000,
		.rx_fixed_delay = 4244,
	},
	[ICE_PTP_LNK_SPD_50G] = {
		...
		.tx_pcs_clk = 390625000, /* 390.625 MHz */
		.rx_pcs_clk = 390625000, /* 390.625 MHz */
		.rx_desk_rsgb_par = 195312500, /* 193.3125 MHz deskew clock */
		.rx_desk_rsgb_pcs = 195312500, /* 193.3125 MHz deskew clock */
		.tx_fixed_delay = 2778,
		.pmd_adj_divisor = 206250000,
		.rx_fixed_delay = 2868,
	},
	[ICE_PTP_LNK_SPD_50G_RS] = {
		...
		.tx_desk_rsgb_par = 322265625, /* 322.265625 MHz RS gearbox */
		.rx_desk_rsgb_par = 322265625, /* 322.265625 MHz RS gearbox */
		.tx_desk_rsgb_pcs = 644531250, /* 644.53125 MHz RS gearbox */
		.rx_desk_rsgb_pcs = 644531250, /* 644.53125 MHz RS gearbox */
		.tx_fixed_delay = 2095,
		.pmd_adj_divisor = 206250000,
		.rx_fixed_delay = 14524,
	},
